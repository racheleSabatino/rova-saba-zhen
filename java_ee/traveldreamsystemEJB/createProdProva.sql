...
INSERT INTO `traveldreamsystem_db`.`hotelspacchper` (`IDPACCHPER`, `DATAACQUISTO`, `LISTAREGALI`, `IDHOTEL`) VALUES ('1', '2014-01-01 00:00:00', '0', '1');
INSERT INTO `traveldreamsystem_db`.`escursionipacchper` (`IDPACCHPER`, `DATAACQUISTO`, `LISTAREGALI`, `IDESCURSIONE`) VALUES ('1', '2014-01-01 00:00:00', '0', '1');
INSERT INTO `traveldreamsystem_db`.`trasportipacchper` (`IDPACCHPER`, `DATAACQUISTO`, `LISTAREGALI`, `IDTRASPORTO`) VALUES ('1', '2014-01-01 00:00:00', '0', '1');
